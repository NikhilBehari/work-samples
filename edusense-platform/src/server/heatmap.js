...
var Canvas2dRenderer = (function Canvas2dRendererClosure() {
  ...
  var _getColorPalette = function(config) {
    ...
    var paletteCanvas = createCanvas(width, height);
  ...
  var _getPointTemplate = function(radius, blurFactor) {
    var tplCanvas = createCanvas(width, height);
  ...
  function Canvas2dRenderer(config) {
    ...
    var shadowCanvas = this.shadowCanvas = createCanvas(width, height);
    var canvas = this.canvas = config.canvas || createCanvas(width, height);
  ...
  Canvas2dRenderer.prototype = {
    ...
    fs.writeFileSync('./heat1.png', buffer)
      if (data.data.length > 0) {
